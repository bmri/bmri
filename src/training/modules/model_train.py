...
def CondInsNorm(input_X,input_Z,reg_param=1.0e-7):
  ...
  Xs = keras.layers.Lambda(lambda x: divide(x - tf.reduce_mean(x,axis=1,keepdims=True),
...
def generator(Input_W=64,Input_H=64,Input_C=1,Z_Dim=50,k0=32,reg_param=1.0e-7):
